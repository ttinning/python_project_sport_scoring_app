...
def update(fixture):
    sql = "UPDATE fixtures SET (team_1_id, team_1_score, team_2_id, team_2_score) = (%s, %s, %s, %s) WHERE id = %s"
    values = [fixture.team_1.id, fixture.team_1_score, fixture.team_2.id, fixture.team_2_score, fixture.id]
    run_sql(sql, values)
